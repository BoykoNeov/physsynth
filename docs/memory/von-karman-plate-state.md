...
Phase-4 **model #6 — von Kármán (Föppl–von Kármán) nonlinear plate** is **PLANNED, not yet built**.
Plan committed at `docs/dev/von-karman-plate-plan.md` (commit 1938941, 2026-06-30). The deep end of
...
[the whole de-risk, no time loop] → (2) F elliptic solve `B_F` + manufactured-soln check → (3)
